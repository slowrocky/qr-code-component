...
function Ac(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Or = null), Uc.apply($c, arguments);
}
...
function kr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Jt(t)), n !== null && nu(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function tu(e, n, t, r) {
  if (Fr) {
    ...
    else if ((Zu(e, r), n & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && Ps(o),
...
var jr = null;
function mo(e, n, t, r) {
  if (((jr = null), (e = qo(r)), (e = kn(e)), e !== null))
...
var Lf = He && "TextEvent" in window && !Ct,
  Ds = He && (!uu || (Ct && 8 < Ct && 11 >= Ct)),
...
function Rf(e, n) {
  if (In)
    return e === "compositionend" || (!uu && Is(e, n))
      ? ((e = Ms()), (Sr = ru = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function $s(e) {
  if (e.propertyName === "value" && ll(jt)) {
    var n = [];
    js(n, jt, e, qo(e)), gs(Mf, n);
  }
}
function If(e, n, t) {
  e === "focusin"
    ? (ui(), (_t = n), (jt = t), _t.attachEvent("onpropertychange", $s))
    : e === "focusout" && ui();
}
function Ff(e) {
...
var Vf = He && "documentMode" in document && 11 >= document.documentMode,
  Fn = null,
  vo = null,
  xt = null,
  ho = !1;
...
var Hs = ol("animationend"),
  Qs = ol("animationiteration"),
  Ws = ol("animationstart"),
  Ks = ol("transitionend"),
  Ys = new Map(),
  ci =
...
function vn() {
  if (!jl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Es(bo, vn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function wa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), al(4, 4, ga.bind(null, n, e), t)
  );
}
function Cu() {}
function ka(e, n) {
...
function Oi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), la(n, t, r), Po(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
  ...
  if (((i = (u & e.childLanes) !== 0), ae || i)) {
    if (((r = Z), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | u) ? 0 : l),
        l !== 0 &&
          l !== o.retryLane &&
          ((o.retryLane = l), We(e, l), Re(r, e, l, -1));
    }
...
function fd(e, n, t) {
  ...
  switch ((au(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Mo(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[So], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Gu(t), n === 1))
      e.tag === 0 ? qf(Vi.bind(null, e)) : Js(Vi.bind(null, e)),
        Xf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Ha(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = br(e, r);
    ...
    R |= 2;
    var o = Wa();
    (Z !== e || q !== n) && ((Ue = null), (rt = Q() + 500), Cn(e, n));
    do
      try {
        wd();
        break;
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Yt), Cn(e, 0), qe(e, r), de(e, Q()), t);
    if (n === 6) qe(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = Pu + 500 - Q()), 10 < n))
          ) {
            if (Ir(e, 0) !== 0) break;
            ...
            e.timeoutHandle = ko(wn.bind(null, e, se, Ue), n);
            break;
          }
          wn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = ko(wn.bind(null, e, se, Ue), r);
            break;
          }
          wn(e, se, Ue);
          break;
  ...
  return de(e, Q()), e.callbackNode === t ? Ha.bind(null, e) : null;
}
function Ao(e, n) {
  var t = zt;
  return (
...
function Vi(e) {
  ...
  if (t === 1) throw ((t = Yt), Cn(e, 0), qe(e, n), de(e, Q()), t);
...
function br(e, n) {
  ...
  while (1);
  if ((du(), (R = t), (Zr.current = r), W !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function gd() {
  for (; W !== null; ) Ka(W);
...
function Sd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > Q() - Pu)
        ? Cn(e, 0)
        : (Nu |= t)),
    de(e, n);
}
...
function Lr(e, n, t, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Ru(e) && (u = 1);
    ...
    e: switch (e) {
      ...
      case Zl:
        return (
          (e = Se(12, t, n, l | 2)), (e.elementType = Zl), (e.lanes = o), e
        );
      case Jl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (eu(n, t | 1), de(n, Q()), !(R & 6) && ((rt = Q() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
hs = zu;
ys = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Jt, Un, ul, ms, vs, zu] },
  ht = {
...
const Od = "./assets/image-qr-code-c38c08d5.png",
  Md = () =>
    be("div", {
      className: "qrCode",
      children: Nc("div", {
        className: "container",
        children: [
          be("img", { src: Od, alt: "image-qr-code" }),
          be("h1", {
...
function Dd() {
  return be("div", { className: "App", children: be(Md, {}) });
}
Kl.createRoot(document.getElementById("root")).render(
  be(wc.StrictMode, { children: be(Dd, {}) })
);
